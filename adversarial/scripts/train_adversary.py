...
parser.add_argument('--path_length', type=int, default=200, help='maximum episode length')
...
parser.add_argument('--n_itr', type=int, default=25000, help='Number of iterations of the alternating optimization')
parser.add_argument('--n_pro_itr', type=int, default=10, help='Number of iterations for the portagonist')
parser.add_argument('--n_adv_itr', type=int, default=10, help='Number of interations for the adversary')
...
print(f"adv_fraction: {adv_fraction}")
